...
const LilyPond = ({ width = 800, height = 600, ...props }) => {
  ...
  return (
  <Svg width={safeWidth} height={safeHeight} viewBox={`0 0 ${safeWidth} ${safeHeight}`} {...props}>
    <Defs>
    ...
    <Path 
      ...
      fill="#6DBF4B" 
      opacity="0.3"
      transform={`translate(${safeWidth * 0.13}, ${safeHeight * 0.25}) rotate(15) scale(1.0)`}
    />
    <Path 
      d="M32,4 C16,6,6,20,8,34 C10,48,24,60,38,58 C52,56,60,44,60,32 C60,20,52,10,40,6 C36,5,32,10,32,18 L40,32 L32,32 Z" 
      fill="#4CAF50" 
      opacity="0.3"
      transform={`translate(${safeWidth * 0.75}, ${safeHeight * 0.18}) rotate(15) scale(0.75)`}
    />
    <Path 
      d="M32,4 C16,6,6,20,8,34 C10,48,24,60,38,58 C52,56,60,44,60,32 C60,20,52,10,40,6 C36,5,32,10,32,18 L40,32 L32,32 Z" 
      fill="#66BB6A" 
      opacity="0.3"
      transform={`translate(${safeWidth * 0.85}, ${safeHeight * 0.43}) rotate(-10) scale(1.09)`}
    />
    <Path 
      d="M32,4 C16,6,6,20,8,34 C10,48,24,60,38,58 C52,56,60,44,60,32 C60,20,52,10,40,6 C36,5,32,10,32,18 L40,32 L32,32 Z" 
      fill="#4CAF50" 
      opacity="0.3"
      transform={`translate(${safeWidth * 0.32}, ${safeHeight * 0.62}) rotate(5) scale(0.94)`}
    />
    <Path 
      d="M32,4 C16,6,6,20,8,34 C10,48,24,60,38,58 C52,56,60,44,60,32 C60,20,52,10,40,6 C36,5,32,10,32,18 L40,32 L32,32 Z" 
      fill="#66BB6A" 
      opacity="0.3"
      transform={`translate(${safeWidth * 0.75}, ${safeHeight * 0.80}) rotate(-20) scale(0.78)`}
    />
  </Svg>
  );
};
