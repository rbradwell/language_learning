...
module.exports = {
  async up(queryInterface, Sequelize) {
    try {
      console.log('Adding vocabulary_pairing to TrailStep type ENUM...');
      
      // Add the new enum value
      await queryInterface.sequelize.query(`
        ALTER TYPE "enum_TrailSteps_type" ADD VALUE 'vocabulary_pairing';
      `);
  ...
  async down(queryInterface, Sequelize) {
    ...
    console.log('The vocabulary_pairing value will remain in the enum.');
  }
};